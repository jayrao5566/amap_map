...
import 'package:amap_map_example/pages/interactive/poi_search_demo.dart';
...
class DemoConfiguration {
  const DemoConfiguration({required this.buildRoute});
...
List<Demo> interactiveDemos() {
  return <Demo>[
    ...
    Demo(
      title: '搜索 POI',
      category: DemoCategory.interactive,
      subtitle: '按关键词和城市检索兴趣点',
      slug: 'poi-search',
      configurations: <DemoConfiguration>[
        DemoConfiguration(
          buildRoute: (BuildContext context) => const PoiSearchDemoPage(),
        ),
      ],
    ),
  ];
